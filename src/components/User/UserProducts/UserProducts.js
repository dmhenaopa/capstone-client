            ...
            <div className={styles.divTabs}>
                ...
                <div className={styles.divProducts}>
                    <div className={styles.divProduct1}>
                        ...
                        <a className={styles.aInstalador219} href='https://alas.com.co/documentos/Instalar/Instalar_ALAS3240_Act219.zip'><button className={styles.buttonDownload}>Descargar</button></a>
                    </div>
                    <div className={styles.divProduct2}>
                        ...
                        <div className={styles.divDownloadButtons}>
                            <a className={styles.aActualizador219} href='https://alas.com.co/documentos/1Actualizar_219/Actualizar_ALAS3240_Act219.zip'><button className={styles.buttonDownload}>Descargar No. 219</button></a>
                            <a className={styles.aActualizador218} href='https://alas.com.co/documentos/2Actualizar_218/Actualizar_ALAS3240_Act218.zip'><button className={styles.buttonDownload}>Descargar No. 218</button></a>
                            <a className={styles.aActualizador217} href='https://alas.com.co/documentos/3Actualizar_217/Actualizar_ALAS3240_Act217.exe'><button className={styles.buttonDownload}>Descargar No. 217</button></a>
                        </div>
                    </div>
                </div>
            </div>
